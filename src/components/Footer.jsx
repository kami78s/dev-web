...
function Footer() {
  return (
    <footer className="px-3 py-12 text-primary font-grotesk bg-background-accent md:grid md:grid-cols-5 md:gap-12 md:px-16 md:py-10 md:mt-36">
      ...
      <p className="mt-12 text-base font-normal font-vietnam md:row-start-3 md:col-start-1 md:col-end-6 text-center md:mt-0">© Copyright {new Date().getFullYear()} Oxyhack Tous Droits Réservés</p>
    </footer>
  )
}
