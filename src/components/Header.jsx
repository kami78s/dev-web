  ...
  return (
    <header className='flex items-center justify-between h-20 px-3 bg-background-accent md:px-16 md:py-6'>
      ...
      <nav>
        ...
        <img src='/logo/hamburger.png' alt="hamburger icon" className="cursor-pointer lg:hidden" onClick={() => setIsNavOpened(true)} />
        <ul className={clsx(`fixed left-0 top-0 flex flex-col justify-center gap-10 items-center h-full w-full transition-transform bg-background/95 text-accent text-4xl font-forma font-medium lg:hidden`, { '-translate-x-full': !isNavOpened })}>
